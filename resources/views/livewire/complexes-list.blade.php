        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg ">
                        ...
                        <tbody>
                            @foreach ($complexes as $complexe)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-2 py-3 flex items-center justify-end border-r border-gray-700">
                                        ...
                                        <div id="{{ $complexe->id }}"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                                ...
                                                <li>
                                                    <a href="{{ route("complexes.edit",$complexe->id) }}"
                                                        class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">modifier
                                                        le Complexe</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route("complexes.efps.create",$complexe->id) }}"
                                                        class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">ajouter un efp</a>
                                                </li>
                                                @if ($complexe->efps->count() > 0) 
                                                    <li>
                                                        <a href="{{ route("complexes.efps.index",$complexe->id) }}"
                                                            class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">voir les efps</a>
                                                    </li>
                                                @endif
                                    ...
                                    <th class="px-4 w-auto py-3"> {{ $complexe->nom_complexe }} </td>
                                    <th class="px-4 w-auto py-3"> {{ $complexe->efps->count() }} </td>
                                </tr>
                            @endforeach
                ...
                <div class="p-4">
                    ...
                    {{ $complexes->links('vendor.livewire.tailwind') }}
                </div>
