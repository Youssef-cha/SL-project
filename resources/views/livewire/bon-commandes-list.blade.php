                    ...
                    <table class="text-nowrap w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-4 w-fit py-3">Numero de bon commande</th>
                            ...
                            @foreach ($bonCommandes as $bonCommande)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-2 py-3 flex items-center justify-end border-r dark:border-gray-700">
                                        <button id="{{ $bonCommande->numero_bon_bonCommandes }}-button"
                                        ...
                                        <div id="{{ $bonCommande->numero_bon_bonCommandes }}"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                                ...
                                                <li>
                                                    <a href="{{ route('bonCommandes.edit', $bonCommande->numero_bon_bonCommandes) }}"
                                                        class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">modifier
                                                        commande</a>
                                                </li>
                                                <li>

                                                    <a href="{{ route('livraisons.edit', $bonCommande->numero_bon_bonCommandes) }}"
                                                        class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">modifier
                                                        livraison</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('receptions.edit', $bonCommande->numero_bon_bonCommandes) }}"
                                                        class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">modifier
                                                        reception</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('depots.edit', $bonCommande->numero_bon_bonCommandes) }}"
                                                        class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">modifier
                                                        depot</a>
                                                </li>
                                                ...
                                                @if ($bonCommande->STATUT_PAIEMENT !== 'non payee')
                                                    <li>
                                                        <a href="{{ route('paiements.edit', $bonCommande->numero_bon_bonCommandes) }}"
                                                            class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">modifier
                                                            paiement</a>
                                                    </li>
                                                @endif
                                                ...
                                                <li>
                                                    <a href="{{ route('bonCommandes.retours.create', $bonCommande->numero_bon_bonCommandes) }}"
                                                        class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">créer une retour</a>
                                                </li>


                                                @if ($bonCommande->retours->count() > 0) 
                                                    <li>
                                                        <a href="{{ route('bonCommandes.retours.index', $bonCommande->numero_bon_bonCommandes) }}"
                                    ...
                                    @if ($bonCommande->retours->count() > 0 )
                                        text-red-500
                                    @endif
                                    "> {{ $bonCommande->numero_bon_bonCommandes }} </td>
                                    ...
                                    <td class="px-4 w-auto py-3"> {{ $bonCommande->rubrique->REFERENCE_RUBRIQUE }} </td>
                                    <td class="px-4 w-auto py-3"> {{ $bonCommande->fournisseur->nom_fournisseur }} </td>
                                    ...
                                    <td class="px-4 w-auto py-3"> {{ $bonCommande->NUM_MARCHE }} </td>
                                    ...
                                    <td class="px-4 w-auto py-3"> {{ $bonCommande->STATUT_COMMANDE }} </td>
                                    ...
                                    <td class="px-4 w-auto py-3"> {{ $bonCommande->DATE_VERIFICATION_RECEPTION }} </td>
