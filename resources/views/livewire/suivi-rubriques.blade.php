        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg ">
                ...
                <div class="flex  items-start justify-around py-2 mb-2 text-gray-600">
                    <h4>Total reste à payer : <span class="text-gray-800 font-semibold">{{ $totalC }}</span> </h4>
                    <h4>Total reste du budget : <span class="text-gray-800 font-semibold">{{ $totalB }}</span>
                    </h4>
                </div>
