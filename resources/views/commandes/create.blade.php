            ...
            <x-form-fields-container>
                ...
                <x-form-select :half="true" label="Type Achat" name="TYPE_ACHAT">
                    @foreach ($achatTypes as $achatType)
                        <option @selected(old('TYPE_ACHAT') == $achatType) value="{{ $achatType }}">{{ $achatType }}</option>
                    @endforeach
                </x-form-select>
                ...
                <x-form-select label="Numéro appel d'offre" name="numero_appel_offre">
                    @foreach ($appelOffres as $appelOffres)
                        <option @selected(old('numero_appel_offre') == $appelOffres->numero_appel_offre) value="{{ $appelOffres->numero_appel_offre }}">
