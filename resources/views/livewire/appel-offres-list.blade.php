                    ...
                    <table class="text-nowrap w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-4 w-fit py-3">marche</th>
                        ...
                        <tbody>
                            @foreach ($appelOffres as $appelOffre)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-2  py-3 flex items-center justify-end border-r dark:border-gray-700">
                                        ...
                                        <div id="{{ $appelOffre->numero_appel_offre }}"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                                ...
                                                <li>
                                                    <a href="{{ route('appelOffres.edit', $appelOffre->numero_appel_offre) }}"
                                    ...
                                    <td class="px-4 w-auto py-3"> {{ $appelOffre->numero_marche }} </td>
                                    <td class="px-4 w-auto py-3"> {{ $appelOffre->commandes->count() }} </td>
                                </tr>
                            @endforeach
